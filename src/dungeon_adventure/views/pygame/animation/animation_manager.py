...
from src.dungeon_adventure.views.pygame.animation.animation import Animation
...
class AnimationManager:
    def __init__(self):
        ...
        # This hierarchy is needed cause if we have unique animations for different actions like walking left or walking
