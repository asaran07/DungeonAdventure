...
class ControlsDisplay:
    ...
    def draw(self, surface: pygame.Surface):
        ...
        surface.blit(
            title_surface,
            (
                self.controls_rect.x + (5 * self.scale_factor),
                self.controls_rect.y + (5 * self.scale_factor),
            ),
        )
        ...
        for i, (key, value) in enumerate(self.keybinds):
            ...
            surface.blit(
                key_surface, (self.controls_rect.x + (10 * self.scale_factor), y_pos)
            )
            surface.blit(
                value_surface, (self.controls_rect.x + (40 * self.scale_factor), y_pos)
            )
